...
java -jar ../build/libs/great-versioning-tool-1.0.jar add a.txt > message.out
if [[ $? -ne 0 ]]; then
    cd -
...
if [[ $(java -jar ../build/libs/great-versioning-tool-1.0.jar history -last 1) = "1: Added file: a.txt" ]]; then
